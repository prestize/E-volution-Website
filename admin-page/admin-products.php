  ...
  <body>
      ...
      <div class="menu-bar">
        <div class="menu">
          <ul class="menu-links">
            ...
            <li class="nav-link">
              <a href="/admin-page/admin-products.php" class="active">
    ...
    <script>
         ...
         function addRow(tableID) {
            ...
            let tableRef = document.getElementById('productRows');
            <?php $index=0;?>
            ...
            // Append a text node to the cell
            let typeTextp = document.createElement('p');
            let typeText = document.createTextNode(type[i]);
            typeTextp.appendChild(typeText);
            typeName.appendChild(typeTextp);
            ...
            // Append a text node to the cell
            let overviewTextp = document.createElement('p');
            let overviewText = document.createTextNode(overview[i]);
            overviewTextp.appendChild(overviewText);
            overviewName.appendChild(overviewTextp);
            ...
            // Append a text node to the cell
            let lwhTextp = document.createElement('p');
            let lwhText = document.createTextNode(lwh[i]);
            lwhTextp.appendChild(lwhText);
            lwhName.appendChild(lwhTextp);
            ...
            // Append a text node to the cell
            let featuresTextp = document.createElement('p');
            let featuresText = document.createTextNode(features[i]);
            featuresTextp.appendChild(featuresText);
            featuresName.appendChild(featuresTextp);

            let col1Name = newRow.insertCell();

            // Append a text node to the cell
            let col1Textp = document.createElement('p');
            let col1Text = document.createTextNode(col1[i]);
            col1Textp.appendChild(col1Text);
            col1Name.appendChild(col1Textp);

            let col2Name = newRow.insertCell();

            // Append a text node to the cell
            let col2Textp = document.createElement('p');
            let col2Text = document.createTextNode(col2[i]);
            col2Textp.appendChild(col2Text);
            col2Name.appendChild(col2Textp);

            let col3Name = newRow.insertCell();

            // Append a text node to the cell
            let col3Textp = document.createElement('p');
            let col3Text = document.createTextNode(col3[i]);
            col3Textp.appendChild(col3Text);
            col3Name.appendChild(col3Textp);

            let col4Name = newRow.insertCell();

            // Append a text node to the cell
            let col4Textp = document.createElement('p');
            let col4Text = document.createTextNode(col4[i]);
            col4Textp.appendChild(col4Text);
            col4Name.appendChild(col4Textp);
